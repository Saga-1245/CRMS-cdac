...
const ForgotPassword = () => {
    ...
    const GenerateAndSendOTP = () => {
        console.log(email);
        axios
            .get(`http://localhost:8081/otp/?email=${email}`)
            .then((Response) => {
    ...
    const HandleOtp = (e) => {
        ...
        if (confirmOtp == otp) {
            ...
            if (pass === cpassword) {
                ...
                axios
                    .put("http://localhost:8081/changepassword", Credential)
                    .then((Response) => {
                        console.log(Response.data);
    ...
    return (
        <>
            <Header />
            <div className="bg-dark" style={{ height: "60px" }}> </div>
