...
export default function Registration() {
  ...
  useEffect(() => {
    // console.log(document.getElementById("customer").checked);
  ...
  function register(e) {
    ...
    if (
      ...
      const registerData = {
        ...
        state: state,
        city: city,
        isTransporter: document.getElementById("transporter").checked,
        isAdmin: false
      };


      axios.post(`${url}/register`, registerData).then((response) => {
        Swal.showLoading();
  ...
  function getSelectedState() {
    setState(document.getElementById("statelist").value);
    console.log(document.getElementById("statelist").value);
  }


  function getSelectedCity() {
    setCity(document.getElementById("citylist").value);
  ...
  function radiocheck() {
    ...
    // console.log(document.getElementById("customer").checked);
    // console.log(document.getElementById("transporter").checked);
  }
          ...
          <div className="row d-flex justify-content-center align-items-center h-100 ">
            <div className="col-lg-8 col-xl-9 ">
              <div
                ...
                style={{ borderRadius: "25px", opacity: "1",backgroundColor:"#8df6fa9a" }}
              >
                  ...
                  <div className="row justify-content-center">
                    <div className="col-md-10 col-lg-6 col-xl-7 order-2 order-lg-1">
                      ...
                      <form className="mx-1 mx-md-4">
                        ...
                        <div className="d-flex flex-row align-items-center mb-4">
                          <i className="fa fa-phone-square fa-lg me-3 fa-fw"></i>
                          <div className="form-outline flex-fill mb-0">
                            <input
                              type="number"
                        ...
                        <div className="d-flex flex-row align-items-center mb-4">
                          ...
                          <div className="form-outline flex-fill mb-0">
                            <select id="statelist" onChange={getSelectedState}
                              className="form-select jp-form-input py-lg-2"
                              required
                            >
                        ...
                        <div className="d-flex flex-row align-items-center mb-4">
                          <i className="fa fa-address-card fa-lg me-3 fa-fw"></i>
                          <div className="form-outline flex-fill mb-0">
                            <select id="citylist" onChange={getSelectedCity}
                            ...
                            >
                              ...
                              <option value="EastChamparan">
                                East Champaran
                              </option>{" "}
                              <option value="EastDelhi">East Delhi</option>{" "}
                              <option value="EastGaroHills">
                                East Garo Hills
                              </option>{" "}
                        ...
                        <div className="form-check">
                          <input className="form-check-input" type="radio" name="flexRadioDefault" onChange={radiocheck} id="customer" checked />
                          <label className="form-check-label" for="flexRadioDefault1">
                            I want to do Order
                          </label>
                        </div>
                        <div className="form-check">
                          <input className="form-check-input" type="radio" name="flexRadioDefault" onChange={radiocheck} id="transporter" />
                          <label className="form-check-label" for="flexRadioDefault2">
                            I can deliver Orders
                          </label>
                        </div>
